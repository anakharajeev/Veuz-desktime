...
$(document).ready(function () {
    function e() {
        ...
        var i = getChartColorsArray("sparkline55");
        i && ($("#sparkline55").sparkline([0, 18, 12, 22, 10, 0], {
            type: "line",
            width: "100%",
            height: "100",
            chartRangeMax: 30,
            resize: !0,
            lineColor: i[0],
            fillColor: "rgba(45, 204, 112, 0.3)",
            highlightLineColor: "rgba(0,0,0,.1)",
            highlightSpotColor: "rgba(0,0,0,.2)"
     
        }));
        var i = getChartColorsArray("sparkline56");
        i && ($("#sparkline56").sparkline([0, 18, 12, 35, 10, 0], {
            type: "line",
            width: "100%",
            height: "100",
            chartRangeMax: 40,
        ...
        var i = getChartColorsArray("sparkline57");
        i && ($("#sparkline57").sparkline([0, 6, 3, 10, 7, 0], {
            type: "line",
            width: "100%",
            height: "100",
            chartRangeMax: 15,
            resize: !0,
            lineColor: i[0],
            fillColor: "rgba(48, 200, 233, 0.3)",
            highlightLineColor: "rgba(0,0,0,.1)",
            highlightSpotColor: "rgba(0,0,0,.2)"
     
        }));
        var i = getChartColorsArray("sparkline58");
        i && ($("#sparkline58").sparkline([0, 3, 1, 5, 0], {
            type: "line",
            width: "100%",
            height: "100",
            chartRangeMax: 8,
